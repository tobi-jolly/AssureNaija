      ...
      <div className="hidden lg:flex relative items-center justify-center bg-gradient-to-br from-primary/5 to-accent/5 p-8">
        <div className="relative w-full max-w-lg aspect-square">
          <Image
            ...
            alt="AssureNaija - Join and secure your future with smart insurance"
            fill
          ...
          <div className="absolute inset-0 flex items-center justify-center text-center pointer-events-none">
            <div className="bg-black/40 backdrop-blur-md px-8 py-6 rounded-2xl max-w-md">
              <h2 className="text-3xl font-bold text-white mb-4">
                Join AssureNaija Today
              </h2>
              <p className="text-white/90 text-lg">
                Get clear, personalized insurance advice tailored for you — no agents, no stress.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center">
            ...
            <p className="text-muted-foreground mt-2">
              Start getting smart insurance recommendations in minutes
            </p>
          </div>
